(function() {
	...
	app.directive('medicalNoteDetail', function($compile){
		function link (scope, iElement, iAttrs){
		    ...
		    scope.delete = function(){ // TBD
		    	iElement.remove();
		    };
		};
		
		function detailController($scope, $element, $rootScope, $location, medicalNoteFactory){	
			var isDetailLoaded = false;
	...
	controllers.medicalDetailController = function($scope, $routeParams, $rootScope, medicalNoteFactory){
		function init(){
